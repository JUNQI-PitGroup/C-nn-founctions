...
void UpdateWeights_1Layers_NN(double* inputTensor, double* labelTensor, double learningRate) {
    UpdateWeights(inputTensor, labelTensor, learningRate);
}

void Forward_1Layers_NN(double* inputTensor, double* outputTensor) {
...
void Save_1Layers_NN_Weight() {
    Save_WeightTensor((double*)weightTensor_1, layer1_neuronNum, inputLength + 1, "./1_layers_fc_nn_saved_weight/1_layers_fc_nn_saved_weight_layer_1_tensor.txt");
}

void Load_1Layers_NN_Weight() {
    Load_WeightTensor((double*)weightTensor_1, layer1_neuronNum, inputLength + 1, "./1_layers_fc_nn_saved_weight/1_layers_fc_nn_saved_weight_layer_1_tensor.txt");
