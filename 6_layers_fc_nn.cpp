...
static double weightTensor_5[layer5_neuronNum][layer4_neuronNum + 1] = { 0 }; // 第五层权重矩阵
static double weightTensor_6[layer6_neuronNum][layer5_neuronNum + 1] = { 0 }; // 输出层权重矩阵
...
static double linear6_outputTensor[layer6_neuronNum] = { 0 };
static double activate6_outputTensor[layer6_neuronNum] = { 0 };

static void UpdateWeights(double* inputTensor, double* labelTensor, double learningRate) {
    // 反向传播
    double layer6_grad[layer6_neuronNum]{};
...
void UpdateWeights_6Layers_NN(double* inputTensor, double* labelTensor, double learningRate) {
    UpdateWeights(inputTensor, labelTensor, learningRate);
}

void Forward_6Layers_NN(double* inputTensor, double* outputTensor) {
...
void Print_6Layers_NN_Weight() {
    ...
    printf("static double weightTensor_6[layer6_neuronNum][layer5_neuronNum + 1] = \n");
    PrintWeightTensor((double*)weightTensor_6, layer6_neuronNum, layer5_neuronNum + 1);
}

void Save_6Layers_NN_Weight() {
    Save_WeightTensor((double*)weightTensor_1, layer1_neuronNum, inputLength + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_1_tensor.txt");
    Save_WeightTensor((double*)weightTensor_2, layer2_neuronNum, layer1_neuronNum + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_2_tensor.txt");
    Save_WeightTensor((double*)weightTensor_3, layer3_neuronNum, layer2_neuronNum + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_3_tensor.txt");
    Save_WeightTensor((double*)weightTensor_4, layer4_neuronNum, layer3_neuronNum + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_4_tensor.txt");
    Save_WeightTensor((double*)weightTensor_5, layer5_neuronNum, layer4_neuronNum + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_5_tensor.txt");
    Save_WeightTensor((double*)weightTensor_6, layer6_neuronNum, layer5_neuronNum + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_6_tensor.txt");
}

void Load_6Layers_NN_Weight() {
    Load_WeightTensor((double*)weightTensor_1, layer1_neuronNum, inputLength + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_1_tensor.txt");
    Load_WeightTensor((double*)weightTensor_2, layer2_neuronNum, layer1_neuronNum + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_2_tensor.txt");
    Load_WeightTensor((double*)weightTensor_3, layer3_neuronNum, layer2_neuronNum + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_3_tensor.txt");
    Load_WeightTensor((double*)weightTensor_4, layer4_neuronNum, layer3_neuronNum + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_4_tensor.txt");
    Load_WeightTensor((double*)weightTensor_5, layer5_neuronNum, layer4_neuronNum + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_5_tensor.txt");
    Load_WeightTensor((double*)weightTensor_6, layer6_neuronNum, layer5_neuronNum + 1, "./6_layers_fc_nn_saved_weight/6_layers_fc_nn_saved_weight_layer_6_tensor.txt");
