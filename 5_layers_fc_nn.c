...
static float weightTensor_1[layer1_neuronNum][inputLength + 1] = { 0 };
static float weightTensor_2[layer2_neuronNum][layer1_neuronNum + 1] = { 0 };
static float weightTensor_3[layer3_neuronNum][layer2_neuronNum + 1] = { 0 };
static float weightTensor_4[layer4_neuronNum][layer3_neuronNum + 1] = { 0 };
static float weightTensor_5[layer5_neuronNum][layer4_neuronNum + 1] = { 0 };
...
static void UpdateWeights(float* inputTensor, float* labelTensor, float learningRate) {
    ...
    // 更新权重
    UpdateLinearWeight_AVX2(&weightTensor_5[0][0], activate4_outputTensor, layer5_grad, layer5_neuronNum, layer4_neuronNum, learningRate);
...
static void Forward(float* inputTensor, float* outputTensor) {
    ...
    for (int i = 0; i < layer5_neuronNum; i++) {
        linear5_outputTensor[i] = Linear_AVX2(activate4_outputTensor, layer4_neuronNum, weightTensor_5[i]);
    }
...
void Save_5Layers_NN_Weight() {
    Save_WeightTensor((float*)weightTensor_1, layer1_neuronNum, inputLength + 1, "./5_layers_fc_nn_saved_weight/5_layers_fc_nn_saved_weight_layer_1_tensor.txt");
    Save_WeightTensor((float*)weightTensor_2, layer2_neuronNum, layer1_neuronNum + 1, "./5_layers_fc_nn_saved_weight/5_layers_fc_nn_saved_weight_layer_2_tensor.txt");
    Save_WeightTensor((float*)weightTensor_3, layer3_neuronNum, layer2_neuronNum + 1, "./5_layers_fc_nn_saved_weight/5_layers_fc_nn_saved_weight_layer_3_tensor.txt");
    Save_WeightTensor((float*)weightTensor_4, layer4_neuronNum, layer3_neuronNum + 1, "./5_layers_fc_nn_saved_weight/5_layers_fc_nn_saved_weight_layer_4_tensor.txt");
    Save_WeightTensor((float*)weightTensor_5, layer5_neuronNum, layer4_neuronNum + 1, "./5_layers_fc_nn_saved_weight/5_layers_fc_nn_saved_weight_layer_5_tensor.txt");
}

void Load_5Layers_NN_Weight() {
    Load_WeightTensor((float*)weightTensor_1, layer1_neuronNum, inputLength + 1, "./5_layers_fc_nn_saved_weight/5_layers_fc_nn_saved_weight_layer_1_tensor.txt");
    Load_WeightTensor((float*)weightTensor_2, layer2_neuronNum, layer1_neuronNum + 1, "./5_layers_fc_nn_saved_weight/5_layers_fc_nn_saved_weight_layer_2_tensor.txt");
    Load_WeightTensor((float*)weightTensor_3, layer3_neuronNum, layer2_neuronNum + 1, "./5_layers_fc_nn_saved_weight/5_layers_fc_nn_saved_weight_layer_3_tensor.txt");
    Load_WeightTensor((float*)weightTensor_4, layer4_neuronNum, layer3_neuronNum + 1, "./5_layers_fc_nn_saved_weight/5_layers_fc_nn_saved_weight_layer_4_tensor.txt");
    Load_WeightTensor((float*)weightTensor_5, layer5_neuronNum, layer4_neuronNum + 1, "./5_layers_fc_nn_saved_weight/5_layers_fc_nn_saved_weight_layer_5_tensor.txt");
